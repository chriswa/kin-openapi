[![Build Status](https://travis-ci.com/chriswa/kin-openapi.svg?branch=master)](https://travis-ci.com/chriswa/kin-openapi)
[![Go Report Card](https://goreportcard.com/badge/github.com/chriswa/kin-openapi)](https://goreportcard.com/report/github.com/chriswa/kin-openapi)
[![GoDoc](https://godoc.org/github.com/chriswa/kin-openapi?status.svg)](https://godoc.org/github.com/chriswa/kin-openapi)
[![Join Gitter Chat Channel -](https://badges.gitter.im/chriswa/kin.svg)](https://gitter.im/chriswa/kin?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Here's some projects that depend on _kin-openapi_:
  * [github.com/chriswa/kin](https://github.com/chriswa/kin) - "A configurable backend"
  ...
  * (Feel free to add your project by [creating an issue](https://github.com/chriswa/kin-openapi/issues/new) or a pull request)
...
# Structure
  * _openapi2_ ([godoc](https://godoc.org/github.com/chriswa/kin-openapi/openapi2))
    * Support for OpenAPI 2 files, including serialization, deserialization, and validation.
  * _openapi2conv_ ([godoc](https://godoc.org/github.com/chriswa/kin-openapi/openapi2conv))
    * Converts OpenAPI 2 files into OpenAPI 3 files.
  * _openapi3_ ([godoc](https://godoc.org/github.com/chriswa/kin-openapi/openapi3))
    * Support for OpenAPI 3 files, including serialization, deserialization, and validation.
  * _openapi3filter_ ([godoc](https://godoc.org/github.com/chriswa/kin-openapi/openapi3filter))
    * Validates HTTP requests and responses
  * _openapi3gen_ ([godoc](https://godoc.org/github.com/chriswa/kin-openapi/openapi3gen))
    * Generates `*openapi3.Schema` values for Go types.
  * _pathpattern_ ([godoc](https://godoc.org/github.com/chriswa/kin-openapi/pathpattern))
...
import (
	...
	"github.com/chriswa/kin-openapi/openapi3filter"
)
